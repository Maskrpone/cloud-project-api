...
If you are unfamiliar with Nix or NixOS, these files are simply the tools we use to guarantee that this project works the same way for everyone, everywhere. They solve common development issues like "It works on my machine!"
